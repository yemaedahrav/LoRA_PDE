...
np.savetxt('pinns/finetuned/finetuning_details/weights_'+str(Re)+'.txt', weights_array)

torch.save(pinn.state_dict(), 'pinns/finetuned/finetuning_details/model_'+str(Re)+'.pt')